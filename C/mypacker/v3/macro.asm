...
%define CTX__LEN 0x2CF
%define CTX__DR0 0x4
%define CTX__DR1 0x8
%define CTX__DR2 0xC
%define CTX__DR3 0x10
%define CTX__ESI 0xA0
%define CTX__EDI 0x9c
%define CTX__ESP 0xC4
%define CTX__EBP 0xB4
%define CTX__EAX 0xB0
%define CTX__EBX 0xA4
%define CTX__ECX 0xAC
%define CTX__EDX 0xA8

; Process Information Structure
%define PROCESS_INFORMATION__LEN 0x10
...
; DOS Header
%define IMAGE_DOS_HEADER__PEOffset 0x3C

; File header 
%define IMAGE_FILE_HEADER_LEN 0x10
